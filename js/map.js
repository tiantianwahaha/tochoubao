window.onload=function(){
    ...
    L.marker([39.90904, -243.7282], {icon: L.AwesomeMarkers.icon({icon: 'heart', prefix: 'fa', markerColor: 'orange', iconColor: '#ffffff'}) }).addTo(mymap)
    ...
    L.marker([40.25596, -243.71349], {icon: L.AwesomeMarkers.icon({icon: 'heart', prefix: 'fa', markerColor: 'red', iconColor: '#ffffff'}) }).addTo(mymap)
	...
	L.marker([43.2777, -275.71965], {icon: L.AwesomeMarkers.icon({icon: 'heart', prefix: 'fa', markerColor: 'orange', iconColor: '#ffffff'}) }).addTo(mymap)
		.bindPopup("<b>2024.09.12 独库公路</b><br /><img src='image/duku.jpg' height=\"100%\" width=\"100%\"/>");
